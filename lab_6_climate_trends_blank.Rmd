...
2. Provide a table (Table 1) of MK p-values and Sen's slopes over the entire period (1900 – 2022). (5 pts)

3. For the average temperature provide a figure that has time on the x and average T on the y. Fit a stat_smooth to this data "stat_smooth(method = "lm")" (5 pt). 
